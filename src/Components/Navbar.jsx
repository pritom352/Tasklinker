...
const Navbar = () => {
  ...
  const links = (
    <div className="flex gap-4  ">
      ...
      <NavLink className="hover:text-blue-500" to="/aboutUs">
        About Us
      </NavLink>
      ...
      <NavLink className="hover:text-blue-500" to="/support">
        Support
      </NavLink>
      ...
      {user && (
        <NavLink className="hover:text-blue-500" to="/dashbord">
          Dashbord
        </NavLink>
      )}
    </div>
  ...
  return (
    <div className="bg-base-300 shadow-sm">
      <div className="navbar sticky top-0 z-50    mx-auto  max-w-6/7  ">
            ...
            <div>
              <Link to="/register">
                <button className="relative mr-2 inline-flex items-center justify-center px-6 py-3  overflow-hidden font-mono font-medium tracking-tighter hover:text-white  rounded-lg group">
                  <span className="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#5eeccd]  rounded-full group-hover:w-56  group-hover:h-56"></span>
